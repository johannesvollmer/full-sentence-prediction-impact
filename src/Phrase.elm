module Phrase exposing (Phrase, phraseSet)
...
phraseSet: List Phrase
phraseSet = String.split "\n" stringData
    |> List.map String.trim
    |> List.filter (not << String.isEmpty)
    |> linesToPhrases

linesToPhrases : List String -> List Phrase
linesToPhrases list =
  case List.take 4 list of
    [] -> []
    target :: variants -> 
      Phrase target variants 
      :: linesToPhrases (List.drop 4 list)
